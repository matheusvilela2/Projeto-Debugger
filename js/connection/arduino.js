...
const cfg = {
    "host": "projeto-debugger.database.windows.net", // server name do banco de dados
    "user": "debugger.tec", // login ("bandtec")
    "pass": "@Bestlab", // senha do banco de dados
    "db": "cliente-debugger.tec" // nome da base de dados
};
...
function registrarLeitura(temperatura, umidade) {
	...
	request = new Request(`
	INSERT into dados (temperatura, umidade, data_time) 
